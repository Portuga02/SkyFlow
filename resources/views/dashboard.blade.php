                                            ...
                                            <div class="flex items-center gap-3 mt-2 flex-wrap">
                                                ...
                                                @if ($todo->category)
                                                    <span class="text-xs font-semibold px-2.5 py-1 rounded-md text-white shadow-xs flex items-center gap-1.5"
                                                        style="background-color: {{ $todo->category->color ?? '#0071c4' }}">
                                                        <i class="{{ $todo->category->icon ?? 'fa-solid fa-tag' }}"></i>
                                                        {{ $todo->category->name }}
                                                    </span>
                                                @endif
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="w-full bg-gray-100 rounded-full h-2.5 overflow-hidden">
                                            ...
                                            <div class="h-2.5 rounded-full transition-all duration-500"
                                                style="width: {{ $percent }}%; background-color: {{ $category->color ?? '#0071c4' }}">
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
