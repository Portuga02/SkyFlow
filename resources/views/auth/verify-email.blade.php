<x-guest-layout>
    <div class="mb-4 text-sm text-gray-600">
        {{ __('Obrigado por se inscrever! Antes de começar, você poderia verificar seu endereço de e-mail clicando no link que acabamos de enviar por e-mail para você?\'Se você não recebeu o e-mail, teremos prazer em enviar-lhe outro.') }}
    </div>
