<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <p class="text-sm text-brand-600 mt-1">{{ __('Escolha um nome, cor e ícone.') }}</p>
        </div>
    </x-slot>
            ...
            <div class="bg-white rounded-2xl shadow-card border border-brand-50 overflow-hidden">
                ...
                <form method="POST" action="{{ route('categories.store') }}" class="p-6 space-y-5"
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-400 mt-1">{{ __('Selecione pra criar esta como uma subcategoria.') }}</p>
                    </div>
