...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div>
            <h2 class="font-extrabold text-2xl text-brand-950 leading-tight"><?php echo e(__('Editar Tarefa')); ?></h2>
            <p class="text-sm text-brand-600 mt-1"><?php echo e(__('Atualize as informações da atividade.')); ?></p>
        </div>
     <?php $__env->endSlot(); ?>
    ...
    <div class="py-10">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-card border border-brand-50">
                ...
                <form method="POST" action="<?php echo e(route('todos.update', $todo->id)); ?>" class="p-6 space-y-5">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'title','class' => 'block w-full','type' => 'text','name' => 'title','required' => true,'value' => ''.e(old('title', $todo->title)).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'title','class' => 'block w-full','type' => 'text','name' => 'title','required' => true,'value' => ''.e(old('title', $todo->title)).'']); ?>
...
<?php endif; ?>
                        <textarea id="description" name="description" rows="4"
                            placeholder="<?php echo e(__('Detalhe a atividade...')); ?>"
                            class="block p-3 w-full text-sm text-gray-900 bg-white rounded-lg border border-brand-200 focus:ring-brand-500 focus:border-brand-500"><?php echo e(old('description', $todo->description)); ?></textarea>
                    </div>

                    <div class="grid grid-cols-2 gap-4">
                        <!-- Dropdown Customizado de Prioridades -->
                        <div x-data="{
                                open: false,
                                selected: '<?php echo e(old('priority', $todo->priority ?? 'high')); ?>',
                                options: {
...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'due_date','class' => 'block w-full text-sm mt-1','type' => 'datetime-local','name' => 'due_date','value' => ''.e(old('due_date', $todo->due_date ? (is_string($todo->due_date) ? date('Y-m-d\TH:i', strtotime($todo->due_date)) : $todo->due_date->format('Y-m-d\TH:i')) : '')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'due_date','class' => 'block w-full text-sm mt-1','type' => 'datetime-local','name' => 'due_date','value' => ''.e(old('due_date', $todo->due_date ? (is_string($todo->due_date) ? date('Y-m-d\TH:i', strtotime($todo->due_date)) : $todo->due_date->format('Y-m-d\TH:i')) : '')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php endif; ?>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <!-- Dropdown Customizado de Categoria Colorido -->
                        <div x-data="{
                                open: false,
                                selected: '<?php echo e(old('category_id', $todo->category_id ?? '')); ?>',
                                cats: [
...
<?php endif; ?>
                        ...
                        <!-- Dropdown Multi-Select de Responsáveis com Fotos Reais (avatar_path) -->
                        <div x-data="{
                                open: false,
                                selected: <?php echo e(json_encode(old('assigned_to', method_exists($todo, 'assignedUsers') ? $todo->assignedUsers->pluck('id')->toArray() : ($todo->assigned_to ? [$todo->assigned_to] : [])))); ?>,
                                users: [
...
<?php endif; ?>
                            ...
                            <button @click="open = !open" @click.outside="open = false" type="button"
                                        ...
                                        <div class="flex items-center gap-1.5 flex-wrap">
                                            <template x-for="id in selected" :key="id">
                                                <span class="inline-flex items-center gap-1.5 bg-indigo-50 border border-indigo-200 text-indigo-700 text-xs font-semibold px-2 py-0.5 rounded-full shadow-xs">
                                                    <img :src="getUser(id)?.avatar" class="w-4 h-4 rounded-full object-cover bg-white">
                                ...
                                <i class="fa-solid fa-chevron-down text-gray-400 text-xs transition-transform duration-200 ml-2" :class="open ? 'rotate-180' : ''"></i>
                            </button>
                                ...
                                <template x-for="user in users" :key="user.id">
                                    <div @click="toggle(user.id)"
                                        ...
                                        <div class="flex items-center gap-3">
                                            <img :src="user.avatar" class="w-8 h-8 rounded-full object-cover border border-indigo-100 shadow-xs bg-slate-50" :alt="user.name">
                    ...
                    <div>
                        <?php if (isset($component)) { $__componentOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'is_completed']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'is_completed']); ?><?php echo e(__('Status da Tarefa')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581)): ?>
<?php $attributes = $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581; ?>
<?php unset($__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581); ?>
...
<?php unset($__componentOriginale3da9d84bb64e4bc2eeebaafabfb2581); ?>
<?php endif; ?>
                        <select id="is_completed" name="is_completed" class="block w-full rounded-lg border-brand-200 focus:border-brand-500 focus:ring-brand-500 text-sm mt-1">
                            <option value="0" <?php if(!$todo->is_completed): echo 'selected'; endif; ?>><?php echo e(__('⏳ Pendente / Em Andamento')); ?></option>
                            <option value="1" <?php if($todo->is_completed): echo 'selected'; endif; ?>><?php echo e(__('✅ Concluído')); ?></option>
                        </select>
                    </div>

                    <div class="flex justify-end gap-3 pt-2">
                        <a href="<?php echo e(route('todos.index')); ?>" class="inline-flex items-center px-4 py-2.5 rounded-lg text-sm font-semibold text-brand-600 bg-brand-50 hover:bg-brand-100 transition">
                        ...
                        <button type="submit" class="inline-flex items-center gap-2 px-5 py-2.5 bg-brand-600 hover:bg-brand-700 text-white text-sm font-semibold rounded-lg shadow-soft transition">
                            <i class="fa-solid fa-check"></i> <?php echo e(__('Salvar alterações')); ?>
...
<?php endif; ?><?php /**PATH C:\Workspace\SkyFlow\resources\views\auth\edit-todo.blade.php ENDPATH**/ ?>