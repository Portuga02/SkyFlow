...
<?php if($messages): ?>
    <ul <?php echo e($attributes->merge(['class' => 'text-sm text-rose-600 space-y-1 mt-2'])); ?>>
        <?php $__currentLoopData = (array) $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li><i class="fa-solid fa-circle-exclamation mr-1"></i><?php echo e($message); ?></li>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </ul>
<?php endif; ?>
<?php /**PATH C:\Users\savio\Downloads\SkyFlow-master\resources\views/components/input-error.blade.php ENDPATH**/ ?>