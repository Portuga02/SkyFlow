...
<?php $component->withAttributes([]); ?>
    <div class="mb-6 text-center">
        <h1 class="text-xl font-extrabold text-brand-950"><?php echo e(__('Bem-vindo de volta')); ?></h1>
        <p class="text-sm text-gray-500 mt-1"><?php echo e(__('Entre para continuar organizando seu fluxo.')); ?></p>
    </div>
...
<?php endif; ?>
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ms-2 text-sm text-gray-600"><?php echo e(__('Lembrar')); ?></span>
            </label>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\savio\Downloads\SkyFlow-master\resources\views/auth/login.blade.php ENDPATH**/ ?>