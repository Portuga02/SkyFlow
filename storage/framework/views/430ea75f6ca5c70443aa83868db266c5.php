...
<?php $component->withAttributes([]); ?>
    <?php
        ...
        $avatarUrl = !empty($user->avatar_path) 
            ...
            : 'https://api.dicebear.com/7.x/notionists/svg?seed=' . urlencode($user->name) . '&backgroundColor=e0e7ff,fef3c7,dbeafe,fce7f3';
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-gradient-to-r from-brand-600 to-blue-500 rounded-2xl p-6 md:p-8 text-white shadow-lg flex flex-col md:flex-row items-start md:items-center justify-between relative overflow-hidden gap-6">
                ...
                <div class="relative z-10 flex items-center gap-4 md:gap-6 w-full md:w-auto justify-between md:justify-end">
                    ...
                    <div id="weather-widget" class="flex items-center gap-3 bg-white/10 backdrop-blur-md px-4 py-2 rounded-xl border border-white/20 shadow-sm transition-all hover:bg-white/20">
                                ...
                                <?php $__currentLoopData = $urgentTodos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $todo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="group flex items-start gap-4 p-4 rounded-xl border border-brand-50 hover:border-brand-200 hover:shadow-md transition bg-white">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <a href="<?php echo e(route('todos.show', $todo->id)); ?>" class="block font-bold text-brand-950 truncate hover:text-brand-600 transition">
                                            ...
                                            <div class="flex items-center gap-3 mt-2 flex-wrap">
                                                ...
                                                <?php if($todo->category): ?>
                                                    <span class="text-xs font-semibold px-2.5 py-1 rounded-md text-white shadow-sm flex items-center gap-1" style="background-color: <?php echo e($todo->category->color); ?>">
                                                        <i class="<?php echo e($todo->category->icon ?? 'fa-solid fa-tag'); ?>"></i> <?php echo e($todo->category->name); ?>
                                                ...
                                                <?php $__currentLoopData = $todo->assignedUsers->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                        $assigneeAvatar = !empty($assignee->avatar_path) 
                                                            ...
                                                            : 'https://api.dicebear.com/7.x/notionists/svg?seed=' . urlencode($assignee->name) . '&backgroundColor=e0e7ff,fef3c7,dbeafe,fce7f3';
                                                    ?>
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div>
                                        <div class="flex justify-between text-sm font-bold mb-1">
                                            <span class="text-brand-950 flex items-center gap-1"><i class="<?php echo e($category->icon ?? 'fa-solid fa-folder'); ?> text-gray-400 text-xs"></i> <?php echo e($category->name); ?></span>
                                        ...
                                        <div class="w-full bg-gray-100 rounded-full h-2.5 overflow-hidden">
                                            ...
                                            ?>
                                            <div class="h-2.5 rounded-full transition-all duration-500" style="width: <?php echo e($percent); ?>%; background-color: <?php echo e($category->color); ?>"></div>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        ...
                        <?php if(isset($recentNotes) && $recentNotes->count() > 0): ?>
                            <div class="space-y-3">
                                <?php $__currentLoopData = $recentNotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="bg-amber-50 border-l-4 border-amber-400 p-3 rounded-r-lg shadow-sm hover:shadow transition cursor-pointer" onclick="window.location.href='/notes'">
