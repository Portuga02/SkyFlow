                                            ...
                                            <div class="flex items-center gap-3 mt-2 flex-wrap">
                                                ...
                                                <?php if($todo->category): ?>
                                                    <span
                                                        ...
                                                        <i
                                                            class="<?php echo e($todo->category->icon ?? 'fa-solid fa-tag'); ?>"></i>
                                            ...
                                            <div class="flex -space-x-2 overflow-hidden flex-shrink-0 mt-1">
                                                <?php $__currentLoopData = $todo->assignedUsers->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <img class="inline-block h-8 w-8 rounded-full ring-2 ring-white object-cover bg-white"
                                                        src="<?php echo e($assigneeAvatar); ?>" alt="<?php echo e($assignee->name); ?>"
                                    ...
                                    <div>
                                        <div class="flex justify-between text-sm font-bold mb-1">
                                            <span class="text-brand-950 flex items-center gap-1"><i
                                                    class="<?php echo e($category->icon ?? 'fa-solid fa-folder'); ?> text-gray-400 text-xs"></i>
                                                <?php echo e($category->name); ?></span>
                                            <span class="text-gray-500"><?php echo e($category->todos_count); ?> <span
