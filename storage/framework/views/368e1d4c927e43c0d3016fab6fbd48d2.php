<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__('Atualizar as informações de perfil e o endereço de e-mail da sua conta.')); ?>
            ...
            <?php if($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && !$user->hasVerifiedEmail()): ?>
                <div>
                    <p class="text-sm mt-2 text-gray-800">
                        <?php echo e(__('Seu endereço de e-mail não está verificado.')); ?>


                        <button form="send-verification"
                            class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            <?php echo e(__('Clique aqui para reenviar o e-mail de verificação.')); ?>
                    ...
                    <?php if(session('status') === 'verification-link-sent'): ?>
                        <p class="mt-2 font-medium text-sm text-green-600">
                            <?php echo e(__('Um novo link de verificação foi enviado para seu endereço de e-mail.')); ?>
...
<?php /**PATH C:\Workspace\SkyFlow\resources\views\profile\partials\update-profile-information-form.blade.php ENDPATH**/ ?>