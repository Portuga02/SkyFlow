<div x-data="globalSearch()" x-show="open" @keydown.escape="open = false" @search-open="open = true"
    ...
    <div class="w-full max-w-2xl bg-white rounded-2xl shadow-lg overflow-hidden"
        ...
        <div class="p-4 border-b border-brand-50">
            <div class="relative">
                ...
                <input type="text" x-model="query" @input="search()"
                    placeholder="<?php echo e(__('Buscar tarefas... (⌘K ou Ctrl+K)')); ?>"
        ...
        <div class="max-h-96 overflow-y-auto">
            <template x-if="loading">
                <div class="p-8 text-center">
                    ...
                    <p class="text-sm text-gray-500 mt-2"><?php echo e(__('Buscando...')); ?></p>
                </div>
            </template>
            ...
            <template x-if="!loading && results.length === 0 && query">
                <div class="p-8 text-center">
                    ...
                    <p class="text-sm text-gray-500"><?php echo e(__('Nenhuma tarefa encontrada.')); ?></p>
                </div>
            </template>
                            ...
                            <div class="flex items-center justify-between gap-2">
                                ...
                                <div class="flex items-center gap-2 shrink-0">
                                    ...
                                    <template x-if="result.priority === 'high'">
                                        <span class="text-xs font-bold bg-rose-100 text-rose-700 px-2 py-1 rounded"><?php echo e(__('Alta')); ?></span>
                                    </template>
                                    <template x-if="result.priority === 'medium'">
                                        <span class="text-xs font-bold bg-amber-100 text-amber-700 px-2 py-1 rounded"><?php echo e(__('Média')); ?></span>
                                    </template>
                                    <template x-if="result.priority === 'low'">
                                        <span class="text-xs font-bold bg-emerald-100 text-emerald-700 px-2 py-1 rounded"><?php echo e(__('Baixa')); ?></span>
                                    </template>
            ...
            <template x-if="!loading && !query">
                <div class="p-8 text-center text-gray-500 text-sm">
                    <?php echo e(__('Digite para buscar tarefas...')); ?>
        ...
        <div class="px-4 py-3 bg-gray-50 border-t border-gray-200 flex items-center justify-between text-xs text-gray-500">
            <span><?php echo e(__('Pressione ESC para sair')); ?></span>
...
<?php /**PATH C:\Workspace\SkyFlow\resources\views\components\search-modal.blade.php ENDPATH**/ ?>